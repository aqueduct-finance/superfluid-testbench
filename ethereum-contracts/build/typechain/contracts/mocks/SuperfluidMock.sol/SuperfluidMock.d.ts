...
export interface SuperfluidMockInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "APP_WHITE_LISTING_ENABLED" | "CALLBACK_GAS_LIMIT" | "MAX_APP_CALLBACK_LEVEL" | "MAX_NUM_AGREEMENTS" | "NON_UPGRADABLE_DEPLOYMENT" | "addToAgreementClassesBitmap" | "allowCompositeApp" | "appCallbackPop" | "appCallbackPush" | "batchCall" | "callAgreement" | "callAgreementWithContext" | "callAppAction" | "callAppActionWithContext" | "callAppAfterCallback" | "callAppBeforeCallback" | "castrate" | "ctxFunc1" | "ctxFunc2" | "ctxUseCredit" | "decodeCtx" | "forwardBatchCall" | "getAgreementClass" | "getAppCallbackLevel" | "getAppManifest" | "getCodeAddress" | "getGovernance" | "getNow" | "getSuperTokenFactory" | "getSuperTokenFactoryLogic" | "initialize" | "isAgreementClassListed" | "isAgreementTypeListed" | "isApp" | "isAppJailed" | "isCompositeAppAllowed" | "isCtxValid" | "isTrustedForwarder" | "jailApp(address)" | "jailApp(bytes,address,uint256)" | "mapAgreementClasses" | "proxiableUUID" | "registerAgreementClass" | "registerApp" | "registerAppByFactory" | "registerAppWithKey" | "removeFromAgreementClassesBitmap" | "replaceGovernance" | "testCtxFuncX" | "updateAgreementClass" | "updateCode" | "updateSuperTokenFactory" | "updateSuperTokenLogic" | "versionRecipient"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "ctxFunc1", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "ctxFunc2", values: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BytesLike>,
    ...
    encodeFunctionData(functionFragment: "jailApp(address)", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "jailApp(bytes,address,uint256)", values: [
        PromiseOrValue<BytesLike>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>
    ]): string;
    ...
    encodeFunctionData(functionFragment: "testCtxFuncX", values: [PromiseOrValue<BytesLike>, PromiseOrValue<BytesLike>]): string;
    ...
    decodeFunctionResult(functionFragment: "jailApp(address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "jailApp(bytes,address,uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "testCtxFuncX", data: BytesLike): Result;
...
export interface SuperfluidMock extends BaseContract {
    ...
    functions: {
        ...
        ctxFunc1(n: PromiseOrValue<BigNumberish>, ctx: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[BigNumber, string]>;
        ctxFunc2(superToken: PromiseOrValue<string>, agreementClass: PromiseOrValue<string>, agreementId: PromiseOrValue<BytesLike>, agreementData: PromiseOrValue<BytesLike>, cbdata: PromiseOrValue<BytesLike>, ctx: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string, string, string, string, string, string]>;
        ...
        "jailApp(address)"(app: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "jailApp(bytes,address,uint256)"(ctx: PromiseOrValue<BytesLike>, app: PromiseOrValue<string>, reason: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        testCtxFuncX(dataWithPlaceHolderCtx: PromiseOrValue<BytesLike>, ctx: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string] & {
            returnedData: string;
        }>;
    ...
    callStatic: {
        ...
        isCtxValid(ctx: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<boolean>;
        isTrustedForwarder(forwarder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        "jailApp(address)"(app: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        "jailApp(bytes,address,uint256)"(ctx: PromiseOrValue<BytesLike>, app: PromiseOrValue<string>, reason: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        mapAgreementClasses(bitmap: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string[]>;
        proxiableUUID(overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        ctxFunc1(n: PromiseOrValue<BigNumberish>, ctx: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        ctxFunc2(superToken: PromiseOrValue<string>, agreementClass: PromiseOrValue<string>, agreementId: PromiseOrValue<BytesLike>, agreementData: PromiseOrValue<BytesLike>, cbdata: PromiseOrValue<BytesLike>, ctx: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        ctxUseCredit(ctx: PromiseOrValue<BytesLike>, appCreditUsedMore: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        ...
        testCtxFuncX(dataWithPlaceHolderCtx: PromiseOrValue<BytesLike>, ctx: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        updateAgreementClass(agreementClassLogic: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        updateCode(newAddress: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        ctxFunc1(n: PromiseOrValue<BigNumberish>, ctx: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ctxFunc2(superToken: PromiseOrValue<string>, agreementClass: PromiseOrValue<string>, agreementId: PromiseOrValue<BytesLike>, agreementData: PromiseOrValue<BytesLike>, cbdata: PromiseOrValue<BytesLike>, ctx: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ctxUseCredit(ctx: PromiseOrValue<BytesLike>, appCreditUsedMore: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        ...
        testCtxFuncX(dataWithPlaceHolderCtx: PromiseOrValue<BytesLike>, ctx: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        updateAgreementClass(agreementClassLogic: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        updateCode(newAddress: PromiseOrValue<string>, overrides?: Overrides & {
...
//# sourceMappingURL=SuperfluidMock.d.ts.map